package com.example.holding_service.holding_service.service;
...
import com.example.holding_service.holding_service.repository.CryptoHoldingRepository;
...
public class CryptoHoldingService {
    ...
    public void handleHolding(long userId, String cryptoTicker, BigDecimal quantity, TransactionType type, BigDecimal price){
        ...
        //in case it does not exist insert new
